...
const ROS2RosbagUploadPreviewTable = (props) => {
  return (
    <Table size="large" aria-label="ros2-rosbag-preview-table">
      <TableHead>
        <TableRow>
          <TableCell key={`ros2-rosbag-preview-filename`} sx={{ fontWeight: "bolder" }}>File Name</TableCell>
          <TableCell key={`ros2-rosbag-preview-desc`} sx={{ fontWeight: "bolder" }}>Description</TableCell>
          <TableCell key={`ros2-rosbag-preview-filesize`} sx={{ fontWeight: "bolder" }}>File Size</TableCell>
          <TableCell key={`ros2-rosbag-preview-control`} sx={{ fontWeight: "bolder" }}>Controls</TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
