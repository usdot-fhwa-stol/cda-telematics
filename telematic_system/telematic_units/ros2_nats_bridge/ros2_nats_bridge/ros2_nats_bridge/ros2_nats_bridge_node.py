...
#         self.logger().info("Connecting to " + self.get_parameter('NATS_SERVER_IP_PORT').get_parameter_value().string_value)

#         await self.nc.connect(self.get_parameter('NATS_SERVER_IP_PORT').get_parameter_value().string_value, reconnected_cb=reconnected_cb, disconnected_cb=disconnected_cb)
