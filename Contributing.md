# CDA Telematics - Collaboration Opportunities

Developed on a publisher-subscriber, cloud based architecture, the CDA Telematics will provide a platform to stream large volume of big data, generated by various CARMA products - CARMA platform (vehicles and Messenger), CARMA Streets, CARMA Cloud and V2X Hub.
...
Welcome to the CDA Telematics contributing guide. There are a few guidelines that we need contributors to follow so that we can have a chance of keeping on top of things.
...
* Ensure the issue was not already reported by searching CDA Telematics [Issues](https://github.com/usdot-fhwa-stol/cda-telematics/issues)
* If you're unable to find an open issue addressing the problem, open a new one.
* Submit a [CDA Telematics issue](<docs/ISSUE_TEMPLATE.md>).
...
## The End
Hope this guide helps you get started in contributing to the CDA Telematics project! 
